...
export default function HelpContent() {
    return (
        <div className="prose prose-sm dark:prose-invert max-w-none p-4 rounded-md border border-border bg-card text-card-foreground">
            <h2 className="font-headline">Help</h2>
            <p>
            ...
            <h3 className="font-headline">I've got data</h3>
            <p>
            ...
            <h3 className="font-headline">I want to draw features</h3>
            <p>
            ...
            <h3 className="font-headline">I want to edit features</h3>
            <p>
            ...
            <h3 className="font-headline">I want to style features</h3>
            <p>
            ...
            <h3 className="font-headline">URL API</h3>
            <p>
                You can interact with GeoDraw programmatically via URL parameters.
            </p>
            <h4 className="font-code">#map=zoom/latitude/longitude</h4>
            <p>
